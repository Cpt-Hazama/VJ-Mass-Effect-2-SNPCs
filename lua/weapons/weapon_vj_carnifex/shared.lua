...
SWEP.CSMuzzleFlashes 			= false -- Use CS:S Muzzle flash?
	...
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/masseffect/weapons/v_357.mdl"
SWEP.WorldModel					= "models/masseffect/weapons/w_357.mdl"
SWEP.HoldType 					= "pistol"
SWEP.ViewModelFlip				= false -- Flip the model? Usally used for CS:S models
SWEP.Spawnable					= true
SWEP.AdminSpawnable				= false
	-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage				= 70/2 -- Damage
SWEP.Secondary.PlayerDamage		= 70/2 -- Put 1 to make it the same as above
...
SWEP.Primary.DefaultClip		= 7 -- How much ammo do you get when you first pick up the weapon?
SWEP.Primary.Recoil				= 2.5 -- How much recoil does the player get?
SWEP.Primary.Cone				= 8 -- How accurate is the bullet? (Players)
SWEP.Primary.Delay				= 2/3 -- Time until it can shoot again
...
SWEP.NPC_NextPrimaryFire 		= 2/3 -- Next time it can use primary fire
