...
SWEP.CSMuzzleFlashes 			= false -- Use CS:S Muzzle flash?
	...
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/masseffect/weapons/v_irifle.mdl"
SWEP.WorldModel					= "models/masseffect/weapons/w_irifle.mdl"
SWEP.HoldType 					= "ar2"
SWEP.ViewModelFlip				= false -- Flip the model? Usally used for CS:S models
SWEP.Spawnable					= true
SWEP.AdminSpawnable				= false
	-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage				= 12/2 -- Damage
SWEP.Secondary.PlayerDamage		= 12/2 -- Put 1 to make it the same as above
...
SWEP.Primary.ClipSizeReload		= 39 -- If there is x amount of bullets left in the clip, then reload
SWEP.Primary.DefaultClip		= 220 -- How much ammo do you get when you first pick up the weapon?
SWEP.Primary.Recoil				= 0.25 -- How much recoil does the player get?
SWEP.Primary.Cone				= 6 -- How accurate is the bullet? (Players)
SWEP.Primary.Delay				= 0.096 -- Time until it can shoot again
...
SWEP.NPC_NextPrimaryFire 		= 0.086 -- Next time it can use primary fire
